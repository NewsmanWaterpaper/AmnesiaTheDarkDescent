...
#define COMMUNITY_VERSION _W("Level Editor - Community version 0.2.3 (SOL Edition)")
...
protected:
	...
	////Hide Icon and Areas////
	cWidgetLabel*	mpHiderLabel;
	cWidgetButton*	mpHiderPreset;
	//Credits
